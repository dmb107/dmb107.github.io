// Get input for pedigree

function button() {
  var x = document.getElementById("myText").value;
  //document.getElementById("demo").innerHTML = x;
  setupDiagram(myDiagram, [
      { key: 502, n: x, s: "M", m:-10, f:-11, a: ["C", "F", "K"] },
      { key: 503, n: "Mother", s: "F", m:-10, f:-11, ux:502, a: ["A", "B", "D"] },
      { key: 504, n: "Self", s: "F", m:502, f:503, a: ["A", "B", "D"] }
    ],
...
function init() {
  ...
  // put button() for father
  setupDiagram(myDiagram, [
      { key: 502, n: "Father", s: "M", m:-10, f:-11, a: ["C", "F", "K"] },
      { key: 503, n: "Mother", s: "F", m:-10, f:-11, ux:502, a: ["A", "B", "D"] },
      { key: 504, n: "Self", s: "F", m:502, f:503, a: ["A", "B", "D"] }
...
survey
    ...
    .add(function (result) {
        document
            ...
            //.textContent = "Bull JSON:\n" + JSON.stringify(result.data, null, 3);
    //button();  // FIGURE OUT HOW TO TRANSLATE JSON RESULTS INTO GENOGRAM DATA
    setupDiagram(myDiagram, [
        { key: 502, n: "NEW DAD", s: "M", m:-10, f:-11, a: ["C", "F", "K"] },
        { key: 503, n: "TWO DAD", s: "M", m:-10, f:-11, ux:502, a: ["A", "B", "D"] },
        { key: 504, n: "Self", s: "F", m:502, f:503, a: ["A", "B", "D"] }
      ],
      4 /* focus on this person */);
    });
